...
def load_model_and_checkpoint_files(folder, folds=None, mixed_precision=None, checkpoint_name="model_best", custom_parameters_path=None):
    """
    ...
    trainer.custom_parameters_path = custom_parameters_path
